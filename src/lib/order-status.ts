...
export const orderStatusHint: Record<string, string> = {
  DRAFT:
    "Менеджер збирає комплектацію (вироби, матеріали, операції, кількості). Далі — передати на розрахунок адміністратору.",
  CALCULATION:
    "На розрахунку в адміністратора: формується калькуляція та пропозиція з ціною. Менеджер комплектацію вже не змінює.",
  PENDING_APPROVAL:
